...
#define STRING_CONFIG_H_AUTHOR "(JScearcy, Anet A4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Delta Prints"
...
#define DELTA
  ...
  #define DELTA_RADIUS 113.0 //mm  Get this value from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT*1.2 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 4000, 4000, 4000, 8000 }
